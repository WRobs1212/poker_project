...
class Card(object):
    ...
    def __init__(self, rank=0, suit=0):
        ...
        if type(suit) == int and type(rank) == int:
            ...
            if suit in range(0,4) and rank in range(0,13):
                self.__suit = suit
                self.__rank = rank
...
##
    ...
    def get_value(self):
        ''' Face cards return 10, the rest return their rank values. Aces are high and return 11.
        '''
        if(self.__rank >= 11):
            return 11
        # ternary expression:
...
class Deck(object):
    ...
    '''
    def __init__(self):
        self.__deck=[Card(rank,suit) for suit in range(0,4) for rank in range(0,13)]
